      ...
      .then((authData) => {
        ...
        firebase
          ...
          .then((idToken) => {
            this.createUser(
              idToken,
              authData.additionalUserInfo.profile.name,
              authData.additionalUserInfo.profile.email,
              ...
              .then(({ data }) => {
                ...
                if (data == 'USER ALREADY EXISTS IN DB') {
                  ...
                  if (!authData.additionalUserInfo.username)
                    authData.additionalUserInfo.username =
                      authData.additionalUserInfo.profile.email;
  ...
  render() {
    return (
      ...
      <div className="wrapper pt-2">
        ...
        <a className="btn clr py-2" id="auth-btn" data-toggle="modal" data-target="#signUp">
          Sign Up
        </a>
            ...
            <div className="modal-content form-elegant">
              ...
              <form>
                ...
                <div className="modal-body mx-4">
                  <div className="md-form pb-1">
                    <label data-error="wrong" data-success="right" htmlFor="Form-username-signup">
                      Email
                    </label>
                    <input
                      type="username"
                  ...
                  <div className="md-form pb-1">
                    <label data-error="wrong" data-success="right" htmlFor="Form-pass-signup">
                      Password
                    </label>
                    <input
                      type="password"
                  ...
                  <div className="text-center pb-1">
                    ...
                    <button
                      ...
                      onClick={this.emailAndPassAuth}
                    >
                      Register
                    </button>
                  </div>
                  <div>{this.state.dupUser ? 'User already exists' : ''}</div>
                </div>
              </form>
              <div className="modal-header text-center">
                {/* Creates close button for popup */}
              ...
              <div className="row my-3 d-flex justify-content-center social">
                ...
                <div className="loginOptions">
                  <button
                    type="button"
                    className="btn btn-white btn-rounded z-depth-1a loginButton"
                    onClick={this.authHandler.bind(this, new firebase.auth.GoogleAuthProvider())}
                    aria-hidden="true"
                  >
                ...
                <div className="loginOptions">
                  <button
                    type="button"
                    className="btn btn-white btn-rounded z-depth-1a loginButton"
                    onClick={this.authHandler.bind(this, new firebase.auth.FacebookAuthProvider())}
                    aria-hidden="true"
                  >
                ...
                <div className="loginOptions">
                  <button
                    type="button"
                    className="btn btn-white btn-rounded z-depth-1a loginButton"
                    onClick={this.authHandler.bind(this, new firebase.auth.GithubAuthProvider())}
                    aria-hidden="true"
                  >
                ...
                <div className="loginOptions">
                  <button
                    type="button"
                    className="btn btn-white btn-rounded z-depth-1a loginButton"
                    onClick={this.authHandler.bind(this, new firebase.auth.TwitterAuthProvider())}
                    aria-hidden="true"
                  >
